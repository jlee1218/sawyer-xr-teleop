...
robot_hostname="192.168.0.100"

# Set *Either* your computers ip address or hostname. Please note if using
# your_hostname that this must be resolvable to the Robot.
your_ip=$(/sbin/ifconfig | grep -A 1 'wlp2s0' | grep 'inet' | awk '{print $2}') # For connecting via wireless network, finds IPV4 Address
# your_ip="192.168.0.1" # For direct ethernet connection
# your_hostname="airlab2.local"
